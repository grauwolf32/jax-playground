"""Batched RL env wrapper for LinearSphere."""
...
from jax_playground.envs.linearsphere import physics
from jax_playground.envs.linearsphere.physics import (
    LinearParams, LinearState, default_params,
    reset as phys_reset, step as phys_step,
)
...
def _obs(state: LinearState, params: LinearParams) -> jnp.ndarray:
...
def env_reset(key: jax.Array, params: LinearParams):
...
def env_step(es: EnvState, action: jnp.ndarray, params: LinearParams):
